...
(Reason: Removing all authentication — no user registration SHALL exist)
...
(Reason: Removing all authentication — no OAuth login SHALL exist)
...
(Reason: Removing all authentication — no login SHALL exist)
...
(Reason: Removing auth — onboarding flow SHALL be removed entirely)
...
(Reason: Removing auth — no protected routes SHALL exist)
